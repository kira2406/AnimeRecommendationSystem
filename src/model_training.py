        ...
        try:
            ...
            try:
                ...
                for epoch in range(len(history.history['loss'])):
                    ...
                    self.experiment.log_metric("train_loss", training_loss, step=epoch)
    ...
    def extract_weights(self, layer_name, model):
        try:
            ...
            return weights
                ...
                raise CustomException("Error during extracting weights", e)
    ...
    def save_model_weights(self, model):
        try:
            ...
            logger.info("User and Anime weights saved successfully")
                ...
                logger.error(str(e))
                raise CustomException("Error during saving weights")
